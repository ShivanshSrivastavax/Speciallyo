...
import { Heart, Lock, Mail, ArrowRight, Sparkles, AlertCircle } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card rounded-3xl p-8 sm:p-10 shadow-2xl border border-white relative overflow-hidden">
          <div className="text-center mb-8">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-rose-500 to-pink-500 flex items-center justify-center text-white mx-auto mb-4 shadow-lg shadow-rose-500/25 animate-pulse">
            ...
            <p className="text-gray-500 text-sm mt-1">
              Sign in to manage your proposals & check responses
            </p>
          </div>
          ...
          <div className="mt-8 text-center border-t border-rose-100 pt-6">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/register" className="font-semibold text-rose-600 hover:text-rose-700 hover:underline">
                Create one free
              </Link>
            </p>
          </div>
